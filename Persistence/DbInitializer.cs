...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User> userManager)
    {
        ...
        {
            new() { DisplayName = "nafad", UserName = "nafad@test.com", Email = "nafad@test.com" },
            new() { DisplayName = "body", UserName = "body@test.com", Email = "body@test.com" },
            new() { DisplayName = "omar", UserName = "omar@test.com", Email = "omar@test.com" }
        };
    ...
    if(context.Acticities.Any()) return;
    ...
    context.Acticities.AddRange(activities);
